...
public:
    ...
    void displayChat() const {
        ...
        for (const auto& msg : messages) {
            cout << "[" << msg->getFormattedTime() << "] " << msg->getSenderId() << ": " << msg->getContent() << endl;
        }
        cout << "=========================" << endl;
    }
};
...
int main() {
    ...
    cout << "\n---- Chat Room ----" << endl;
    app->sendMessage("user1", "user2", "Hi Garima, Kaise ho?");
    
    app->sendMessage("user2", "user1", "Hi Gautam, Ma bdiya tum btao");
